...
form.addEventListener("submit", function(event) {
    ...
    // Validar campo de aceptar términos y condiciones (No lo pide, pero lo agregué adicionalmente)
    if (!terms.checked && password.value !== "") {
        alert("Por favor acepte los términos y condiciones");
        errors = true;
    }
